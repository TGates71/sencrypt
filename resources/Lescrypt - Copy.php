...
class Lescript
{
    ...
    {
        print_r('Starting certificate generation process for $domain <br>');
...
//        foreach ($domains as $domain) {
            ...
            print_r("Token for $domain saved at $tokenPath and should be available at $uri<br>");
